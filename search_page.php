...
<section class="books" style="padding-top: 0;">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="category"><?php echo $fetch_book['category']; ?></div>
      ...
      <input type="hidden" name="book_category" value="<?php echo $fetch_book['category']; ?>">
      <input type="hidden" name="book_image" value="<?php echo $fetch_book['image']; ?>">
      <input type="submit" class="btn" value="add to borrow" name="add_to_borrow">
   </form>
   <?php
            }
         }else{
